...
public class ClassController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<SingleResponse<ClassResponse>> getById(@PathVariable Integer id) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<SingleResponse<ClassResponse>> update(@PathVariable Integer id,
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<SingleResponse<ClassResponse>> deleteById(@PathVariable Integer id) {
